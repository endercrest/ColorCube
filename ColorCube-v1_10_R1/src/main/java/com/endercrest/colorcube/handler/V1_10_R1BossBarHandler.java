...
import com.endercrest.colorcube.handler.bossbar.V1_10_R1BossBar;

public class V1_10_R1BossBarHandler implements BossBarHandler {

    @Override
    public BossBar createBossBar(String title, BossBar.BarColor color, BossBar.BarStyle style, BossBar.BarFlag... flags) {
        BossBar bossBar = new V1_10_R1BossBar();
