...
public class StatusBarAPI {
    ...
    public static void setStatusBar(Player player, String text, float percent) {
        ...
        if (dragon == null) {
            dragon = new FakeDragon(player.getLocation().add(0, 100, 0), text, percent);
            ...
            sendPacket(player, dragon.getTeleportPacket(player.getLocation().add(0, 100, 0)));
        }
    ...
    private static void sendPacket(Player player, Object packet) {
        try {
            ...
            Method sendPacket = ReflectionUtils.getMethod(connection.getClass(), "sendPacket", NMSUtil.getNmsClass("Packet"));
